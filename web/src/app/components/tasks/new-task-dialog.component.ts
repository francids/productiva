...
@Component({
  ...
  template: `
  <h2 mat-dialog-title i18n="@@dialogs.create-task">Crear tarea</h2>
  <mat-dialog-content>
    <form [formGroup]="taskForm" (ngSubmit)="taskForm.valid && onSaveClick()">
      ...
      <mat-form-field>
        <mat-label i18n="@@dialogs.task-description">Descripción de la tarea</mat-label>
        <textarea matInput formControlName="description"></textarea>
        @if (taskForm.get('description')!.hasError('required')) {
          <mat-error i18n="@@dialogs.error.description-required">La descripción es obligatoria.</mat-error>
        }
      </mat-form-field>
    </form>
  </mat-dialog-content>
  <mat-dialog-actions>
    ...
    <button mat-button (click)="onSaveClick()" [disabled]="taskForm.invalid" i18n="@@dialogs.save">Guardar</button>
  </mat-dialog-actions>
  `,
  styles: [`
  form {
